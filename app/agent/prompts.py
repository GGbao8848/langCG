SYSTEM_PROMPT = (
    ...
    "Remote sftp training uses the script command prefix and defaults batch=24; local training uses the saved local YOLO virtualenv path, runs yolo detect train, and defaults batch=8. "
